...
def ask_anvi(question):
    ...
    try:
        ...
        # ============================================================
        # TROUBLESHOOTING MUST PRECEDE SIMPLE PCI FOLLOW-UP
        # ============================================================
        # A question such as:
        #   "What should I check if PT_303 is not working?"
        # is both an instrument-context question and a troubleshooting
        # question. Troubleshooting/V5 must receive priority so ANVI
        # does not return only the PCI status record.
        #
        # The existing troubleshooting route remains authoritative.
        # No new reasoning engine is created here.

        troubleshooting_intent = any(x in ql for x in [
            "what should i check",
            "what should we check",
            "how do i troubleshoot",
            "how should i troubleshoot",
