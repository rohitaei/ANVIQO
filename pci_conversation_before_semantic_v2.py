...
def answer(question):
    ...
    # Semantic collection queries MUST run before exact-tag lookup.
    # This prevents DI/AI/AO/DO and similar tokens from being treated
    # as instrument identities.
    semantic = _semantic_pci_query(question)
