...
# The production response is currently being generated by the chat-stability
# layer, which has its own older _plant_context resolver. Patch that resolver
# to the same membership authority so the boundary fix cannot be bypassed.
try:
    import anvi_chat_stability_v2 as _chat_stability
    _chat_stability._plant_context = resolve
