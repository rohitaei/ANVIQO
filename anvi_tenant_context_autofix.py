        ...
        def membership_answer(text):
            ...
            try:
                ...
                return stability._safe(
                    ...
                    blocked=True, reason="TENANT_CONTEXT_ERROR",
